        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        <x-dropdown-link href="{{ route('receipts.index') }}">
                        Receipts
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Roster::class)
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Receipt::class)
                <x-jet-responsive-nav-link href="{{ route('receipts.index') }}">
                Receipts
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Roster::class)
                <x-jet-responsive-nav-link href="{{ route('rosters.index') }}">
                Rosters
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Sale::class)
